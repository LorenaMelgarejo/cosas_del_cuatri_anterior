...
using Clase_12_Library_2;//Agregue using al namespace de vehiculo
using Clase_12_Library;//agregue using
...
namespace Clase_12
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(concecionaria.Mostrar(concecionaria,Concecionaria.ETipo.Automovil));// con c minuscula 
            Console.WriteLine("<---------------------------------------------->");
            Console.ReadKey();
        }
    }
