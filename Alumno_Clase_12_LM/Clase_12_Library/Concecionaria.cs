...
{
    public class Concecionaria //no se puede crear una instancia de clase abstracta
    {
        ...
        public Concecionaria()// private
        {
            this._vehiculos = new List<Vehiculo>();
        }
        public Concecionaria(int espacioDisponible):this()//hereda el constructor sin parametros
        {
